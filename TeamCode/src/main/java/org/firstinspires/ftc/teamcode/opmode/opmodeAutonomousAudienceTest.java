...
@Config
@Autonomous(name = "Auto - Audience - Test", group = "_auto", preselectTeleOp = "Teleop Main")
@Disabled
public class opmodeAutonomousAudienceTest extends LinearOpMode {
    // ------------------------------------------------------------
...
//        telemetry.update();
            ...
            // ----------------------------------------------------
            // Trajectory Sequence for - Testing
            // ----------------------------------------------------
            TrajectorySequence trajSeqTest = sysDrivetrain.trajectorySequenceBuilder(startPose)
                    ...
                    .lineToSplineHeading(new Pose2d(14, -54, Math.toRadians(90))) // was 98
...
//                    .lineToSplineHeading(new Pose2d(14, -39, Math.toRadians(98)))
                    ...
                    // Move to Cycle Lane
                    .lineToSplineHeading(new Pose2d(14, -39, Math.toRadians(90))) // was 98

                    // Move Across Field - to other side
                    .lineToSplineHeading(new Pose2d(14, 48, Math.toRadians(90)), // was 98
                            sysDrivetrain.getVelocityConstraint(utilRobotConstants.Drivetrain.Autonomous.MOTOR_MAX_VELOCITY_CROSSFIELD, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                            sysDrivetrain.getAccelerationConstraint(DriveConstants.MAX_ACCEL)
                    )
            ...
            // ----------------------------------------------------
            sysDrivetrain.followTrajectorySequence(trajSeqTest);
