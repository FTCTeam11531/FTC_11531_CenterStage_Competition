...
/**
 * <h2>System - Drivetrain - Mecanum Drive</h2>
 * <hr>
 ...
 * robot drivetrain and movement controls.
 * </p>
 * <br>
 */
public class sysDrivetrainMecanum {
    ...
    private RevHubOrientationOnRobot.LogoFacingDirection controlHubLogoDirection = utilRobotConstants.Configuration.CONTROLHUB_LOGO_DIRECTION;
    private RevHubOrientationOnRobot.UsbFacingDirection controlHubUsbDirection = utilRobotConstants.Configuration.CONTROLHUB_USB_DIRECTION;
    ...
    public void init() {
        ...
        stateDriveMotorMaxOutputPower = enumStateDriveMotorMaxOutputPower.Medium;
...
//        imuParameters.angleUnit = BNO055IMU.AngleUnit.RADIANS;
    ...
    public void driveTurnToHeading(double inTargetHeading, double inOutputPowerPercent) {
        ...
        getSteeringCorrection(inTargetHeading, utilRobotConstants.Drivetrain.HEADING_P_DRIVE_GAIN);

        // Loop while not at heading
        while (sysOpMode.opModeIsActive() && (Math.abs(trackHeadingError) >= 1.0)) {

            robotTurnSpeed = getSteeringCorrection(inTargetHeading, utilRobotConstants.Drivetrain.HEADING_P_TURN_GAIN);
...
//            sysOpMode.telemetry.update();
    ...
    public void driveDistanceAxial(double inAxialInches, double inMaxOutputPowerPercent) {
        ...
        moveTargetPosition = (int)(inAxialInches * utilRobotConstants.Drivetrain.ENCODER_TICKS_PER_INCH);
...
//            sysOpMode.telemetry.update();
    ...
    public void driveDistanceLateral(double inLateralInches, double inMaxOutputPowerPercent) {
        ...
        // Determine Encoder cycle value needed to move incoming distance
        moveTargetPosition = (int)(inLateralInches * utilRobotConstants.Drivetrain.ENCODER_TICKS_PER_INCH);
...
//            sysOpMode.telemetry.update();
    ...
    public void driveEncoderOdometryAxial(double inAxialInches, double inMaxOutputPowerPercent) {
...
//            sysOpMode.telemetry.update();
    ...
    public void driveEncoderOdometryLateral(double inLateralInches, double inMaxOutputPowerPercent) {
