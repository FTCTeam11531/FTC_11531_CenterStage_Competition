...
@Config
@Autonomous(name = "Auto - Scoretable - Test", group = "_auto", preselectTeleOp = "Teleop Main")
@Disabled
public class opmodeAutonomousScoretableTest extends LinearOpMode {
    // ------------------------------------------------------------
...
//        telemetry.update();
            ...
            // ----------------------------------------------------
            // Trajectory Sequence for - Blue Alliance - Scoretable Side - Zone One
            // ----------------------------------------------------
...
//                .lineToSplineHeading(new Pose2d(-14, 48, Math.toRadians(85)))
            ...
            // ----------------------------------------------------
            // Trajectory Sequence for - Blue Alliance - Scoretable Side - Zone Two
            // ----------------------------------------------------
...
//                .lineToSplineHeading(new Pose2d(-14, 48, Math.toRadians(90)))
            ...
            // ----------------------------------------------------
            // Trajectory Sequence for - Blue Alliance - Scoretable Side - Zone Three
            // ----------------------------------------------------
...
//                .lineToSplineHeading(new Pose2d(-14, 48, Math.toRadians(90)))
            ...
            // ----------------------------------------------------
            // Trajectory Sequence for - Blue Alliance - Scoretable Side - Default (when detection goes wrong)
            // ----------------------------------------------------
            TrajectorySequence trajSeqBlueAudienceZoneDefault = trajSeqBlueAudienceZoneThree;


            // ----------------------------------------------------
            // Trajectory Sequence for - Red Alliance - Scoretable Side - Zone Three
            // ----------------------------------------------------
...
//                    .strafeTo(new Vector2d(64, 54))
            ...
            // ----------------------------------------------------
            // Trajectory Sequence for - Red Alliance - Scoretable Side - Zone Two
            // ----------------------------------------------------
...
//                .lineToSplineHeading(new Pose2d(-14, 48, Math.toRadians(90)))
            ...
            // ----------------------------------------------------
            // Trajectory Sequence for - Red Alliance - Scoretable Side - Zone One
            // ----------------------------------------------------
...
//                .lineToSplineHeading(new Pose2d(14, 48, Math.toRadians(90)))
            ...
            // ----------------------------------------------------
            // Trajectory Sequence for - Red Alliance - Scoretable Side - Default (when detection goes wrong)
            // ----------------------------------------------------
